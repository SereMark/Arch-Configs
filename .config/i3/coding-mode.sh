...
i3-msg "workspace 2; exec alacritty -e bash -c \"cd \$HOME/projects && nvim Hibrid-Chess-AI/train.py\"; split h; exec alacritty --working-directory \$HOME/projects/Hibrid-Chess-AI -e claude; resize shrink width 10 px or 10 ppt" &>/dev/null || true
